...
#預測結果讀取
adv_fig = np.load("adv_fig_defence.npy")
pre_fig = np.load("pre_fig_defence.npy")
...
io.savemat('pre_fig_defence',{'pre_fig_defence':pre_fig})
io.savemat('adv_fig_defence',{'adv_fig_defence':adv_fig})
